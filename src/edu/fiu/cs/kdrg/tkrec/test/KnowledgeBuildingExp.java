...
public class KnowledgeBuildingExp {
	
	public static final String DB_EVENT_XML_FILENMAE = "data2/automaton/raw_automaton.xml";
//	public static final String DB_EVENT_XML_FILENMAE = "data2/raw_data.xml";
	public static final String REPEATED_PATTERN_PHRASE_FILENAME = "data2/automaton/result_pattern_extraction_10";
	public static final String ENTITY_PHRASES_FILENAME = "data2/result_entity_phrases";
	public static final String ACTTION_PHRASES_FILENAME = "data2/result_action_phrases";
	public static final String STATISTICS_CLASSTAGGER_FILENAME = "data2/result_statistics_classtagger";
